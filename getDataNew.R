...
tsI <- read_excel("Daten/Corona Zahlen Staedtevergleich.xlsx", sheet = "Zeit_Infected")
tsD <- read_excel("Daten/Corona Zahlen Staedtevergleich.xlsx", sheet = "Zeit_Tote")
#tsT <- read_excel("Daten/Corona Zahlen Staedtevergleich.xlsx", sheet = "Zeit_genesen")
tsE <-read_excel("Daten/Corona Zahlen Staedtevergleich.xlsx", sheet = "Einwohner") %>% mutate(Country = 'Städte')


# Datensatz zusammenbauen -------------------------------------------------

tsI <- mkr.makelongcoronadata_Zeit(tsI,"infected")
tsD <- mkr.makelongcoronadata_Zeit(tsD,"deceased")
#tsT <- mkr.makelongcoronadata_Zeit(tsT,"recovered")
